...
<main class="main">
    ...
    <section id="hero" class="hero section dark-background" style="min-height: 30vh; padding: 40px 0;">
        <div class="image-background">
            <img src="assets/img/services-img/IoT-Development.jpg" alt="Hero Image" id="hero-image">
        </div>
        <div class="container">
            <div class="row gy-4">
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <img src="assets/img/serviceDetailed/IOT/1.jpg" alt="" class="img-fluid services-img">
                </div>
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <h3>(IOT) Internet Of Things Development
                    </h3>
                    <p>
                        <strong>We deliver</strong> smart and agile autonomous solutions to streamline technological
                            innovations for your business. Our expert IoT developers cater to your unique
