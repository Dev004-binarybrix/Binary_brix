...
<main class="main">
    ...
    <section id="hero" class="hero section dark-background" style="min-height: 30vh; padding: 40px 0;">
        <div class="image-background">
            <img src="assets/img/services-img/Web-Development.jpg" alt="Hero Image" id="hero-image">
        </div>
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-7 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                    <h1 class="fs-1"><span class="text-white">Web Application Development</span></h1>
                    <p>
                        Tailor-made web applications <span class="d-none d-sm-inline"> designed to improve operational efficiency.</span>
                    </p>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <img src="assets/img/serviceDetailed/Web/1.jpg" alt="" class="img-fluid services-img">
                </div>
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
