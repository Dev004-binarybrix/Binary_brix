        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-7 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                    ...
                    <p>
                        Versatile cross-platform apps<span class="d-none d-sm-inline"> that ensure broad reach and consistency.</span>
                    </p>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <img src="assets/img/serviceDetailed/Mobile/1.jpg" alt="" class="img-fluid services-img">
                </div>
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>
                        Grow your business to new heights with our expert mobile application
                            development services. Partner with BinaryBrix to achieve top-tier mobile
                            app solutions that drive success and innovation.
                    </p>
                    <p>
